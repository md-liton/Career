    ...
    <nav className='bg-yellow-500'>
      <div className="container">
        <div className={`nav_main flex justify-between items-center py-[10px] bg-green-500`}>
          ...
          <div className='md:hidden absolute top-0 left-0 z-[99] w-[80%] bg-red-500 rounded-r-lg'>
            <div className='p-5 '>
              <div className='flex justify-between items-center'>
              <div className='w-[50px] h-[50px] rounded-full bg-green-500 '></div>
              <IoClose className='text-[25px] cursor-pointer'/>
              </div>
              <div className=''>
              <p className='text-[20px] font-bold'>name</p>
              <Menu/>
              <button className='bg-green-500 py-[8px] px-[25px] rounded-lg text-white cursor-pointer'>Login</button>
              </div>
            </div>
          </div>
        </div>
